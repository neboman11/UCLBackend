...
namespace UCLBackend.Service.Migrations
{
    ...
    [Migration("20210907234916_AddEaglesTeam")]
    partial class AddEaglesTeam
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UCLBackend.Service.Data.DataModels.Account", b =>
                {
            ...
            modelBuilder.Entity("UCLBackend.Service.Data.DataModels.Player", b =>
                {
                    b.Property<int>("PlayerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UCLBackend.Service.Data.DataModels.Team", b =>
                {
                    b.Property<int>("TeamID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UCLBackend.Service.Data.DataModels.Account", b =>
                {
                    b.HasOne("UCLBackend.Service.Data.DataModels.Player", "Player")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("UCLBackend.Service.Data.DataModels.Player", b =>
                {
                    b.HasOne("UCLBackend.Service.Data.DataModels.Team", "Team")
                        .WithMany("Players")
