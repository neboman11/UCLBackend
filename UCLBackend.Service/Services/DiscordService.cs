        ...
        public async Task AddLeagueRolesToUser(ulong discordId, PlayerLeague league)
        {
            ...
            switch (league)
            {
                case PlayerLeague.Origins:
                    discordRoleId = ulong.Parse(_settingRepository.GetSetting("League.Origins.RoleId"));
                    break;
        ...
        public async Task AddFranchiseRolesToUser(ulong discordId, PlayerFranchise franchise, PlayerLeague league)
        {
            ...
            switch (franchise)
            {
                ...
                case PlayerFranchise.Cobras:
                    ...
                    break;
                case PlayerFranchise.Cubs:
                    discordRoleId = ulong.Parse(_settingRepository.GetSetting("Franchise.Cubs.RoleId"));
                    break;
                case PlayerFranchise.Eagles:
                    discordRoleId = ulong.Parse(_settingRepository.GetSetting("Franchise.Eagles.RoleId"));
                    break;
